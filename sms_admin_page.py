    ...
    def take_idfromlogin(ids,email_v,mains):
        ...
        if m==True:
           ...
           # b1 = Button(frame1, text='Generate Report',width=20,bg='green',fg='white',font=("times new roman",15,"bold"))
            #b1.place(x=220,y=40)
            b2 = Button(frame1, text='New Employee/deal',width=20,bg='green',fg='white',font=("times new roman",15,"bold"),command=request)
            ...
            b4 = Button(frame1, text='Products Details',width=20,bg='green',fg='white',font=("times new roman",15,"bold"),command=product)
